...
export default function Modal() {
    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e : any) => {
        ...
        try {
          const response = await axios.post('http://localhost:5000/api/addTodo', {formData})
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                ...
                <form className="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" onSubmit={handleSubmit}>
                    <h3 className="text-xl font-medium text-gray-900 ">Create new todo</h3>
                    <div>
                    ...
                    <button type="submit" className="w-full text-white focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-indigo-500 hover:bg-indigo-700 focus:ring-indigo-200">Confirm</button>
                </form>
            </div>
                </Dialog.Panel>
              </Transition.Child>
